...
| Basic text splitter                          | Text splitting wiht CharacterTextSplitter and RecursiveCharacterTextSplitter                                   | [ollama_text_splitter_basic.py](ollama_text_splitter_basic.py)       |
...
| Vector database                              | Simple document splitting and embedding to ChromaDB and retriaval with prompt                                  | [ollama_chromadb_basic.py](ollama_chromadb_basic.py)                                                                 |